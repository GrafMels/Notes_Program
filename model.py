...
class Model:
    ...
    def repeating_in_book(self, book, book_selection):
        ...
        if function_selection == "1":
            ...
            note = note_builder.build_new_note(list_answer[0], list_answer[1], list_answer[2], self.book_list[book_selection][0])
        ...
        try:
            ...
            if int(input_list[1]) < input_list[2]+1 and int(input_list[1]) > 0:
                    if func_id == 0:
                        ...
                        self.book_list[book_selection][1].set_note(int(input_list[1]), View.edit_note(note))
                    elif func_id == 2:
                        pass
            elif int(input_list[1]) == 0:
                    return True
